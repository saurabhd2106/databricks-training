# Sample data for batch ADLS Auto Loader demo

Prepared from the repo-root [`sample-data`](../../../sample-data/) folder (same layout as the streaming project).
...
See the project [README](../../README.md) for the full walkthrough.
